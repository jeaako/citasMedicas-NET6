    ...
    public partial class citamedica : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MEDICO_PACIENTE", x => new { x.MedicoId, x.PacienteId });
                    table.ForeignKey(
                        name: "FK_MEDICO_PACIENTE_MEDICOS_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "MEDICOS",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MEDICO_PACIENTE_PACIENTES_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "PACIENTES",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MEDICO_PACIENTE_PacienteId",
